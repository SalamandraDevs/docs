...
**Other languages:** [Español — Principios SOLID](../es/architecture/principios-solid.md) · [Índice en español](../es/README.md)
...
- Add or update translations under `docs/es/` when contributing Spanish content.
